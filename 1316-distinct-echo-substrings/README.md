<h2><a href="https://leetcode.com/problems/distinct-echo-substrings/">1244. Distinct Echo Substrings</a></h2><h3>Hard</h3><hr><p>Return the number of <strong>distinct</strong> non-empty substrings of <code>text</code>&nbsp;that can be written as the concatenation of some string with itself (i.e. it can be written as <code>a + a</code>&nbsp;where <code>a</code> is some string).</p>
